...
namespace Application.Controllers
{
    public class StudentController : Controller
    {
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var student = await _context._students
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Address,Phone")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,Name,Email,Address,Phone")] Student student)
        {
            if (id != student.Id)
            {
                return NotFound();
        ...
        {
          return (_context._students?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
